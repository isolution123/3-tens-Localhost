...
var $ci_inf,
    ...
    $(document).ready(function(){
        ...
        $("#car_calc").click(function(){
            ...
            $("#hidden_crfuture_amount").val(addCommas2(Math.round(fv)));  
            $("#hidden_crmonthly_amount").val(addCommas2(Math.round(car_value)));         
            $("#hidden_crlumpsum_amount").val(addCommas2(Math.round(LumpsumInvestment)));
