...
//            console.log('age',childAge);
            ...
            $('#hidden_mrfuture_amount').val(addCommas2(futurevalue.toFixed(0)));
            $('#hidden_mryearly_amount').val(addCommas2(marriageLumpsum));
            $('#hidden_mrmonthly_amount').val(addCommas2(op));
