...
var $hi_inf,
    ...
    $(document).ready(function(){
        ...
        $("#home_calc").click(function(){
            ...
            $("#hidden_hcfuture_amount").val(addCommas2(Math.round(fv)));    
            $("#hidden_hcmonthly_amount").val(addCommas2(Math.round(home_value)));          
            $("#hidden_hclumpsum_amount").val(addCommas2(Math.round(hLumpsumInvestment)));
