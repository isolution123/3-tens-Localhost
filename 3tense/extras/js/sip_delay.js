...
function ResetSlider_Delay()
    ...
    $(document).ready(function(){
        ...
        //  alert(test);
            ...
            $('#hidden_invvaluetoday').val(delimitNumbersValue(Math.round(PV_amt)));
            $('#hidden_invvaluedelay').val(delimitNumbersValue(Math.round(E_value)));
            $('#hidden_lostmoney').val(delimitNumbersValue(Math.round(PV_amt-E_value)));
            
			 //code for client calc Visit strt
               $.ajax({
                        type:'POST',
                        url:'Calculators/SaveCalcVisit',
                        data:{'calcType':'SIPdelay'},
