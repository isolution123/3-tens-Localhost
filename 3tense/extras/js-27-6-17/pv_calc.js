    ...
    $(document).ready(function(){
        ...
        $('#calpv').click(function(){          
         ...
         $("#btn_calcPV").click(function(){
            ...
            var RateOfReturn = $("#pv_rateOfReturn").val().replace(/,/g , "");
            var installment = $("#pv_installment").val().replace(/,/g , "");
    ...
    var pvupdateincomeValue = function () {  
        ...
        $pvito.val(delimitNumbersValue(pvito));
        //$ato.val(ato);
    };
    ...
    var pvupdatebalanceValue = function () {
        $pvbto.val(delimitNumbersValue(pvbto));
    };
