    ...
    public function change()
    {
      ...
      if(!empty($oldpass) && !empty($newpass) && !empty($cnfmpass))
      {
        if($newpass==$cnfmpass)
        {
          ...
          $data['message'] = '<div style=" color:#a94442; padding: 15px; margin-bottom: 20px; border: 1px solid transparent; border-radius: 4px; background-color:#ebccd1">New Password and Confirm Password do not match. Please try again!</div>';
          $data['title']='3tense | Change Password';
          $this->load->view('client/common/header');
          $this->load->view('client/change_pwd',$data);
          $this->load->view('client/common/footer');
          ...
          $data['message'] = '<div style=" color:#a94442; padding: 15px; margin-bottom: 20px; border: 1px solid transparent; border-radius: 4px; background-color:#ebccd1">Password fields cannot be blank</div>';
          $data['title']='3tense | Change Password';
          $this->load->view('client/common/header');
          $this->load->view('client/change_pwd',$data);
          $this->load->view('client/common/footer');
