...
/*for CAMS client Folio file auto import*/
      ...
      $emails = imap_search($inbox, 'SUBJECT "WBR9. Investor Static details feed - CRMS Format, Request Id" SINCE "'.$mailDate.'" ');
        ...
        //  var_dump($emails);
          ...
          //  echo " Mails for today";
              ...
              {
                   unset($abscence_id,$read_arr,$to_part,$brokerName,$PW,$pwd);
                //echo $email_number;
...
// for mutual fund transaction  import
   if($cams_auto_import[$mainkey]=="WBR2. Investor Transactions for a Period, Request Id"){
     $temails = imap_search($inbox, 'SUBJECT "WBR2. Investor Transactions for a Period, Request Id" SINCE "'.$mailDate.'"');
...
//Cams SIP import
 ...
 $semails = imap_search($inbox, 'SUBJECT "WBR49. SIP/STP procured for the period, Request Id" SINCE "'.$mailDate.'" ');
