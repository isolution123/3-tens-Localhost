                          ...
                          foreach($rows as $cell)
                          {
                             ...
                             /*--changes in franklin new format--*/
                              if($countRow == 0)
                              {
                                ...
                                if(strtoupper($cell)=='SL NO' ||strtoupper($cell)=='DIST ID'||strtoupper($cell)=='ACCOUNT NUMBER'||
                              ...
                              else
                              {
                                    ...
                                    if($insertRow)
                                    {
                                            ...
                                            else if(strtoupper($dataColumns[$countCell]) === 'ACCOUNT_N1' || strtoupper($dataColumns[$countCell]) === 'FOLIO ID')//folio_id
                                            {
                                            ...
                                            else if(strtoupper($dataColumns[$countCell]) === 'STARTDATE' || strtoupper($dataColumns[$countCell]) === 'START DATE')//start_data
                                            {
                                            ...
                                            else if(strtoupper($dataColumns[$countCell]) === 'ENDDATE' ||strtoupper($dataColumns[$countCell]) === 'END DATE')//last_date
                                            {
                                              $cell=trim(str_replace('/','-',$cell));                                    
                                                    if($cell || $cell != '')
                                                    {
                                            ...
                                            else if(strtoupper($dataColumns[$countCell]) === 'ECS ACCOUNT TYPE' || strtoupper($dataColumns[$countCell]) === 'BANK')//bank_id
                                            {
                                                    $bank_name = $cell;
                                                    $bank_id=$bankid->bank_id;

                                            }
                                            else if(strtoupper($dataColumns[$countCell]) === 'ECS ACCOUNT NUMBER' || strtoupper($dataColumns[$countCell]) === 'Bank_AccountNo')//bank_id
                                            {
                                                    $Bank_AccountNo = $cell;
                                            ...
                                            else if(strtoupper($dataColumns[$countCell]) === 'IT_PAN_NO' || strtoupper($dataColumns[$countCell]) === 'PAN_NO' || strtoupper($dataColumns[$countCell]) === 'PAN')//client_id
                                            {
                                              ...
                                              else if(strtoupper($dataColumns[$countCell]) === 'SIP REGISTERED DATE' || strtoupper($dataColumns[$countCell]) === 'REGDATE')//added on date
                                              {
                                                ...
                                                else if(strtoupper($dataColumns[$countCell]) === 'SIP TRANSACTION NUMBER' || strtoupper($dataColumns[$countCell]) === 'SIP_TXN_NO')//installment_amt
                                                {
                                                    ...
                                                    else if(strtoupper($dataColumns[$countCell]) === 'INVESTOR NAME')
                                                    {
                                                      if($cell || $cell != '')
                                                      {
                                                          $invname = trim($cell);
