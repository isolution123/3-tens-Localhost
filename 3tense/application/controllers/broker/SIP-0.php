                          ...
                          foreach($rows as $cell)
                          {
                            //echo $cell;
                              ...
                              if($countRow == 0)
                              {
                                  ...
                                  strtoupper($cell)=='AUTO_AMOUN'||strtoupper($cell)=='FROM_DATE'||strtoupper($cell)=='TO_DATE'||
                                  strtoupper($cell)=='CEASE_DATE'||strtoupper($cell)=='PERIODICIT'||strtoupper($cell)=='PERIOD_DAY'||
                                  strtoupper($cell)=='INV_IIN' || strtoupper($cell)=='PAYMENT_MO' || strtoupper($cell)=='TARGET_SCH'||
                                  ...
                                  strtoupper($cell)=='CHEQ_MICR_' || strtoupper($cell)=='AC_HOLDER_' || strtoupper($cell)=='PAN'
                                  || strtoupper($cell)=='TOP_UP_PER' || strtoupper($cell)=='EUIN' || strtoupper($cell)=='SUB_ARN_CO'
                                  || strtoupper($cell)=='TER_LOCATI')
                                        {
                                          $message='match';
                              ...
                              else
                              {
                                    ...
                                    if($insertRow)
                                    {
                                            ...
                                            else if(strtoupper($dataColumns[$countCell]) === 'INSTRM_NO' || strtoupper($dataColumns[$countCell]) === 'INSTRM_NO')//installment_amt
                                            {
                                                  ...
                                                  {
                                                      $insertRow = false;
                                                      $impMessage = "INSTRM No. Cannot be empty";
                                                  }
  ...
  $frequency='monthly';//by default
                             $dataRows['add_SIP_list'] = array (
                                                              ...
                                                              //var_dump($dataRows['add_SIP_list']);
                                                                  $assets_record=array('ref_number'=>$auto_trno,'folio_no'=>$folio_id,'client_id'=>$client_id);
                          ...
                          foreach($rows as $cell)
                          {
                            //echo $cell;
                              ...
                              if($countRow == 0)
                              {
                                  ...
                                  if(strtoupper($cell)=='PRODUCT'||strtoupper($cell)=='SCHEME'||strtoupper($cell)=='FOLIO_NO'||
                                  strtoupper($cell)=='INV_NAME'||strtoupper($cell)=='AUT_TRNTYP'||strtoupper($cell)=='AUTO_TRNO'||
                                  strtoupper($cell)=='AUTO_AMOUNT'||strtoupper($cell)=='FROM_DATE'||strtoupper($cell)=='TO_DATE'||
                                  strtoupper($cell)=='CEASE_DATE'||strtoupper($cell)=='PERIODICITY'||strtoupper($cell)=='PERIOD_DAY'||
                                  strtoupper($cell)=='INV_IIN' || strtoupper($cell)=='PAYMENT_MODE' || strtoupper($cell)=='TARGET_SCHEME'||
                                  strtoupper($cell)=='REG_DATE'||strtoupper($cell)=='SUBBROKER'|| strtoupper($cell)=='REMARKS' ||
                                  strtoupper($cell)=='TOP_UP_FRQ' ||
                                  strtoupper($cell)=='TOP_UP_AMT' ||
                                  strtoupper($cell)=='AC_TYPE' ||
                                  strtoupper($cell)=='BANK' || strtoupper ($cell)=='BRANCH' || strtoupper($cell)=='INSTRM_NO' ||
                                  strtoupper($cell)=='CHEQ_MICR_NO' || strtoupper($cell)=='AC_HOLDER_NAME' || strtoupper($cell)=='PAN'
                                  || strtoupper($cell)=='TOP_UP_PERC' || strtoupper($cell)=='EUIN' || strtoupper($cell)=='SUB_ARN_CODE'
                                  || strtoupper($cell)=='TER_LOCATION')
                                        {
                                          $message='match';
                                      $dataColumns[$countCell] = $cell;
                                      $countCell++;
                              ...
                              else
                              {
                                    ...
                                    if($insertRow)
                                    {
                                            ...
                                            else if(strtoupper($dataColumns[$countCell]) === 'AUTO_AMOUNT' || strtoupper($dataColumns[$countCell]) === 'AMOUNT')//installment_amt
                                            {
                                                  if($cell || $cell != '')
                                                  {
                                                       $auto_amoun = $cell;
                      ...
                      foreach($excelData as $rows)
                      {
                          ...
                          /*foreach($rows as $cell)
                          {
                            //echo $cell;
                              ...
                              {
                                   $cell = str_replace(array('.'), '', $cell);
                                  if(strtoupper($cell)=='PRODCODE'||strtoupper($cell)=='BRANCH'||strtoupper($cell)=='LOCATION'||
                                  strtoupper($cell)=='IHNO'||strtoupper($cell)=='FOLIO'||strtoupper($cell)=='INVNAME'||
                                  strtoupper($cell)=='REGDATE'||strtoupper($cell)=='STARTDATE'||strtoupper($cell)=='ENDDATE'||
                                  strtoupper($cell)=='NOOFINSTAL'||strtoupper($cell)=='AMOUNT'||strtoupper($cell)=='SCHEME'||
                                  strtoupper($cell)=='PLAN' || strtoupper($cell)=='AGENTCODE' || strtoupper($cell)=='AGENTNAME'||
                                  strtoupper($cell)=='SUBBROKER'||strtoupper($cell)=='SCHEMENAME'|| strtoupper($cell)=='PAN' ||
                                  strtoupper($cell)=='SIPTYPE' ||
                                  strtoupper($cell)=='SIPMODE' ||
                                  strtoupper($cell)=='FUNDCODE' || strtoupper($cell)=='ZONE' || strtoupper ($cell)=='FREQUENCY' || strtoupper($cell)=='TRTYPE' ||
                                  strtoupper($cell)=='TOSCHEME' || strtoupper($cell)=='TOPLAN' || strtoupper($cell)=='TERMINATED'
                                  || strtoupper($cell)=='STATUS' || strtoupper($cell)=='TOPRODUCTC' || strtoupper($cell)=='TOSCHEMENA'
                                  || strtoupper($cell)=='ECSNO' || strtoupper($cell)=='ECSBANKNAM' || strtoupper($cell)=='ECSACNO'
                                  || strtoupper($cell)=='ECSHOLDERN' || strtoupper($cell)=='REGSLNO' ||  strtoupper($cell)=='INVDPID' ||
                                   strtoupper($cell)=='INVCLIENTI' || strtoupper($cell)=='DP_INVNAME' || strtoupper($cell)=='MODIFYFLAG' ||
                                   strtoupper($cell)=='UMRNCODE'
                                  )
                                        {
                                        //$message='match';
                                      $dataColumns[$countCell] = $cell;
                              ...
                              else
                              {
                                    ...
                                    if($insertRow)
                                    {
                                      ...
                                      if(strtoupper($dataColumns[$countCell]) === 'FOLIO' || strtoupper($dataColumns[$countCell]) === 'FOLIO_NO')//folio_id
                                      {
                                        ...
                                        else
                                        {
                                          ...
                                          $impMessage="Folio Id cannot be empty";
                                      ...
                                      else if(strtoupper($dataColumns[$countCell]) === 'PRODCODE' || strtoupper($dataColumns[$countCell]) === 'PRODUCT_CODE')//product_id
                                            {
                                            ...
                                            else if(strtoupper($dataColumns[$countCell]) === 'REG_DATE' || strtoupper($dataColumns[$countCell]) === 'REGDATE')//added on date
                                            {
                                              ...
                                              else if(strtoupper($dataColumns[$countCell]) === 'STARTDATE' || strtoupper($dataColumns[$countCell]) === 'START_DATE')//start_data
                                              {
                                              ...
                                              else if(strtoupper($dataColumns[$countCell]) === 'ENDDATE' ||strtoupper($dataColumns[$countCell]) === 'END_DATE')//last_date
                                              {
                                                if($cell || $cell != '')
                                                {
                                                      // $date = new DateTime($cell);
                                              ...
                                              else if(strtoupper($dataColumns[$countCell]) === 'TERMINATED')
                                              {
                        ...
                        foreach($rows as $cell)
                          {
                            //echo $cell;
                              ...
                              {
                                   $cell = str_replace(array('.'), '', $cell);
                                  if(strtoupper($cell)=='PRODUCT CODE'||strtoupper($cell)=='BRANCH'||strtoupper($cell)=='LOCATION'||
                                  strtoupper($cell)=='IHNO'||strtoupper($cell)=='FOLIO'||strtoupper($cell)=='INVESTOR NAME'||
                                  strtoupper($cell)=='REGISTRATIONDATE'||strtoupper($cell)=='START DATE'||strtoupper($cell)=='END DATE'||
                                  strtoupper($cell)=='NO OF INSTALLMENTS'||strtoupper($cell)=='AMOUNT'||strtoupper($cell)=='SCHEME'||
                                  strtoupper($cell)=='PLAN' || strtoupper($cell)=='AGENTCODE' || strtoupper($cell)=='AGENTNAME'||
                                  strtoupper($cell)=='SUBBROKER'||strtoupper($cell)=='SCHEME NAME'|| strtoupper($cell)=='PAN' ||
                                  strtoupper($cell)=='SIPTYPE' ||
                                  strtoupper($cell)=='SIP MODE' ||
                                  strtoupper($cell)=='FUND CODE' || strtoupper($cell)=='ZONE' || strtoupper ($cell)=='FREQUENCY' || strtoupper($cell)=='TRTYPE' ||
                                  strtoupper($cell)=='TO SCHEME' || strtoupper($cell)=='TO PLAN' || strtoupper($cell)=='TERMINATEDATE'
                                  || strtoupper($cell)=='STATUS' || strtoupper($cell)=='TOPRODUCTCODE' || strtoupper($cell)=='TOSCHEMENAME'
                                  || strtoupper($cell)=='ECSNO' || strtoupper($cell)=='ECSBANKNAME' || strtoupper($cell)=='ECSACNO'
                                  || strtoupper($cell)=='ECSHOLDERNAME' || strtoupper($cell)=='REGSLNO' ||  strtoupper($cell)=='INVDPID' ||
                                   strtoupper($cell)=='INVCLIENTID' || strtoupper($cell)=='DP_INVNAME' || strtoupper($cell)=='MODIFYFLAG' ||
                                   strtoupper($cell)=='SIP_UMRNCODE'
                                  )
                                        {
                                        //$message='match';
                                      $dataColumns[$countCell] = $cell;
                              ...
                              else
                              {
                                    ...
                                    if($insertRow)
                                    {
                                      ...
                                      if(strtoupper($dataColumns[$countCell]) === 'FOLIO' || strtoupper($dataColumns[$countCell]) === 'FOLIO_NO')//folio_id
                                      {
                                        ...
                                        else
                                        {
                                          ...
                                          $impMessage="Folio Id cannot be empty";
                                      ...
                                      else if(strtoupper($dataColumns[$countCell]) === 'PRODCODE' || strtoupper($dataColumns[$countCell]) === 'PRODUCT CODE')//product_id
                                            {
                                            ...
                                            else if(strtoupper($dataColumns[$countCell]) === 'REG_DATE' || strtoupper($dataColumns[$countCell]) === 'REGISTRATIONDATE')//added on date
                                            {
                                              ...
                                              else if(strtoupper($dataColumns[$countCell]) === 'TERMINATEDATE')
                                              {
                                              ...
                                              else if(strtoupper($dataColumns[$countCell]) === 'PAN_NO' || strtoupper($dataColumns[$countCell]) === 'PAN')//client_id
                                              {
                                                if($cell || $cell != '')
                                                {
                                                  ...
                                                  else if(strtoupper($dataColumns[$countCell]) === 'BANK' || strtoupper($dataColumns[$countCell]) === 'ECSBANKNAME')//bank_id
                                                  {
                                                ...
                                                else if(strtoupper($dataColumns[$countCell]) === 'INVESTOR NAME')//scheme_id
                                                {
                                                      if($cell || $cell != '')
                                                      {
                                                          $invname = trim($cell);
                                    ...
                                    $countCell++;
                                        ...
                                        if(strtoupper($dataColumns[$countCell]) === 'INVESTOR NAME')//client_id
                                            {
                          ...
                          foreach($rows as $cell)
                          {
                              ...
                              else
                              {
                                    ...
                                    if($insertRow)
                                    {
                                            ...
                                            if(strtoupper($dataColumns[$countCell]) === 'PRODUCT_12' || strtoupper($dataColumns[$countCell]) === 'PRODUCT_CODE')//product_id
                                            {
                                            ...
                                            else if(strtoupper($dataColumns[$countCell]) === 'ACCOUNT_N1' || strtoupper($dataColumns[$countCell]) === 'FOLIO_NO')//folio_id
                                            {
                                            ...
                                            else if(strtoupper($dataColumns[$countCell]) === 'ECS_ACCT15' || strtoupper($dataColumns[$countCell]) === 'BANK')//bank_id
                                            {
                                                    $bank_name = $cell;
                                                    $bank_id=$bankid->bank_id;

                                            }
                                            else if(strtoupper($dataColumns[$countCell]) === 'ECS_ACCNO' || strtoupper($dataColumns[$countCell]) === 'Bank_AccountNo')//bank_id
                                            {
                                                    $Bank_AccountNo = $cell;
                                            ...
                                            else if(strtoupper($dataColumns[$countCell]) === 'IT_PAN_NO' || strtoupper($dataColumns[$countCell]) === 'PAN_NO' || strtoupper($dataColumns[$countCell]) === 'PAN')//client_id
                                            {
                                              ...
                                              else if(strtoupper($dataColumns[$countCell]) === 'SIP_REG_14' || strtoupper($dataColumns[$countCell]) === 'REGDATE')//added on date
                                              {
                                                ...
                                                else if(strtoupper($dataColumns[$countCell]) === 'SIP_TXN_NO' || strtoupper($dataColumns[$countCell]) === 'SIP_TXN_NO')//installment_amt
                                                {
                                                      if($cell || $cell != '')
                                                      {
                                                          $ref_number = $cell;
                                                    ...
                                                    else if(strtoupper($dataColumns[$countCell]) === 'INVESTOR_7')//scheme_id
                                                    {
                                                      if($cell || $cell != '')
                                                      {
                                                          $invname = trim($cell);
                                    ...
                                    $countCell++;
                                        ...
                                        if(strtoupper($dataColumns[$countCell]) === 'INVESTOR_7')//client_id
                                            {
