                          ...
                          foreach($rows as $cell)
                          {
                            //echo $cell;
                              ...
                              if($countRow == 0)
                              {
                                  ...
                                  || strtoupper($cell)=='TER_LOCATI' || strtoupper($cell)=='TER_LOCATION')
                                        {
                                          $message='match';
                            ...
                            //echo $cell;
                              ...
                              else
                              {
                                      ...
                                      if(strtoupper($dataColumns[$countCell]) === 'FOLIO' || strtoupper($dataColumns[$countCell]) === 'FOLIO_NO')//folio_id
                                      {
                                        ...
                                        else
                                        {
                                          ...
                                          $impMessage="Folio Id cannot be empty";
                                            ...
                                            else if(strtoupper($dataColumns[$countCell]) == 'REGDATE' || strtoupper($dataColumns[$countCell]) == 'REG_DATE' || strtoupper($dataColumns[$countCell]) == 'REGISTRATIONDATE')//added on date
                                            {
                                              ...
                                              else if(strtoupper($dataColumns[$countCell]) === 'PAN_NO' || strtoupper($dataColumns[$countCell]) === 'PAN')//client_id
                                              {
                                                ...
                                                else if(strtoupper($dataColumns[$countCell]) === 'INVESTOR NAME' || strtoupper($dataColumns[$countCell]) === 'INVNAME')//scheme_id
                                                {
                                                      if($cell || $cell != '')
                                                      {
                                                          $invname = trim($cell);
                                    ...
                                    $countCell++;
                                        ...
                                        if(strtoupper($dataColumns[$countCell]) === 'INVESTOR NAME' || strtoupper($dataColumns[$countCell]) === 'INVNAME')//client_id
                                            {
                      ...
                      foreach($excelData as $rows)
                      {
                          ...
                          foreach($rows as $cell)
                          {
                              ...
                              if($countRow == 0)
                              {
                                  ...
                                  strtoupper($cell)=='START DATE'|| strtoupper($cell)=='SECOND DATE'||strtoupper($cell)=='END DATE'||
                                  strtoupper($cell)=='NAV'||strtoupper($cell)=='PURUNITS'||strtoupper($cell)=='AMOUNT'||
                                  strtoupper($cell)=='FREQUENCY' || strtoupper($cell)=='INSTALLMENT(S)' || strtoupper($cell)=='POST DATE'
