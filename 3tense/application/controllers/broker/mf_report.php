                              ...
                              <div class="col-md-6 addon" id="addon">
                                    <div class="col-md-9 no-border">
                                          <table>
                                            ...
                                            <tr><td style="padding-right:10px;"><label><input  type="checkbox" id="net_investmet" class="select_all" value="net_investmet"> Net Investmet</label></td><td style="padding-right:10px;"><label><input  type="checkbox" id="scheme_summary" value="scheme_summary" class="select_all"> Schemewise Summary</label></tr>
                                          </table>
                                    </div>
                              </div>
                            </div>
