...
class Nfo_Detail extends CI_Controller{
    ...
    function get_mf_report_historical()
    {
        ...
        if($flag==1)
        {
            ...
            {
              //Clientwise Summary report
              $client_wise_summary_by_year=$this->mf->get_clientwise_summary_historical_new($type,$where1);
            }
             if($report_type == 'schemewise_detail')
            {
              //Schemewise Detail Report
        ...
        else
        {
            ...
            {
              //Clientwise Summary report
              $client_wise_summary_by_year=$this->mf->get_clientwise_summary_new($type,$where1);
            }
             if($report_type == 'schemewise_detail')
            {
              //Schemewise Detail Report
