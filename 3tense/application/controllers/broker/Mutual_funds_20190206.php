        ...
        if (isset($_POST["Import"]))
        {
            ...
            if (isset($_FILES["import_mf"]))
            {
                ...
                else
                {
                    ...
                    if(pathinfo($_FILES["import_mf"]["name"], PATHINFO_EXTENSION)=='dbf')
                    {
                                ...
                                if($insertRow)
                                {
                                        ...
                                        strtoupper($dataColumns[$countCell]) == 'IT_PAN_NO1')
                                    {
                                        ...
                                        if($cell || $cell != '')
                                        {
                                            ...
                                            {
                                                if($c_info->merge_ref_id || $c_info->merge_ref_id!='')
                                                {
                                                    $wherePan = array(
                                                        'c.client_id'=>$c_info->merge_ref_id
