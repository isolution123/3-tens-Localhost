...
/*for CAMS client Folio file auto import*/
      ...
      $emails = imap_search($inbox, 'SUBJECT "Subscribed Master AUM/Investor Master Details Report for Reference No" SINCE "'.$mailDate.'" UNSEEN');
        //echo "<pre>";print_r($emails);exit;
          ...
          //  echo " Mails for today";
              ...
              foreach($emails as $email_number)
              {
                   ...
                   unset($abscence_id,$read_arr2,$to_part,$brokerName,$PW,$pwd,$extracted_file);
                    echo"\n"."********************Folio**********************************"."<br>";
                     echo $email_number;
                ...
                //}
                  ...
                  //echo $final_link;
                            ...
                            echo"link=".$bc_url."<br>";
                                ...
                                $match_par= substr($extracted_file, 0, strpos($extracted_file, '.'));
                                echo"extract file=".$match_par."<br>";
                                    foreach($today_karvy as $file2){
                               if(!is_dir($file2)){
                                                     if (strpos($file2,$match_par) !== false) { 
                                                         $read_arr2=$file2;
                                                               }
                                                      }
                                                      unset($file2);
                                    ...
                                    if(strpos($read_arr2, 'downloads/Folio_master_list/karvy_folder/')=== false){
                                                                  ...
                                                                  $abscence_id=$PW[0]['id'];
                                                                  echo"Import File Name:".$read_arr2."\n";
                                                                  echo"Broker Id:".$abscence_id."\n";
...
// for mutual fund transaction  import
   if($karvy_auto_import[$mainkey]=="Subscribed Transaction Feeds Report for Reference No"){
     $temails = imap_search($inbox, 'SUBJECT "Subscribed Transaction Feeds Report for Reference No" SINCE "'.$mailDate.'" UNSEEN');
         ...
         //  echo " Mails for today";
             ...
             foreach($temails as $temail_number)
             {
               ...
               //  if($tcomp_today_date === $yesterday){
                   echo"date matched for email_number=".$temail_number."\n";
                 ...
                 //echo $final_link;
                             ...
                             echo"link=".$bc_url;
                              //get the date for which you want bhav_copy - start with todays date
                                ...
                                //for excel imporrt for karvy mf
           ...
           if(!is_dir($file)){
             if(preg_match('#^' . 'WBT'. '.*?\.xls$#', $file)) {
              $tread_arr=$file;
                            ...
                            // echo $link;
                               $extracted_file=str_replace('https://www.karvymfs.com/karvy/Subreports/','',$link);
                          //echo $extracted_file."<br>";
                          $extract_after=substr($extracted_file, strpos($extracted_file, "WT")+strlen("WT"));
                          $extract_before=substr($extract_after, 0, strpos($extract_after, ".zip"));
                          $extract_before="WT".$extract_before;
                         // echo $extract_before;
                          if (strpos($file2,$extract_before) !== false) { 
                                                         $tread_arr=$file2;
                                                               }
...
unset($abscence_id1,$tread_arr,$to_part_mf,$brokerName,$PW1,$pwd1);//@pallavi 2018-03-29
...
//Karvy SIP import
 ...
 $semails = imap_search($inbox, 'SUBJECT "SUBSCRIPTION SIP REGISTRATION Report for Ref. No" SINCE "'.$mailDate.'" UNSEEN');
  ...
  //  echo " Mails for today";
      ...
      //echo $final_link;//exit;
                 ...
                 //  echo $bc_url;//exit;
                     ...
                     //echo $file2;
                       $extracted_file=str_replace('https://www.karvymfs.com/karvy/Subreports/','',$link);
                    $extract_after=substr($extracted_file, strpos($extracted_file, "EG")+strlen("EG"));
                          $extract_before=substr($extract_after, 0, strpos($extract_after, ".zip"));
                          $extract_before="EG".$extract_before;
                         // echo $extract_before;
                          if (strpos($file2,$extract_before) !== false) { 
                                                         $sread_arr=$file2;
                                                               }
                                   ...
                                   $cell=$rows[$findkey];
                                     ...
                                     //   echo $clientName; //exit;
                                         ...
                                         if(count($c_info) == 0)
                                         {
                                            ...
                                            // echo"in client id=".$clientId."\n";
                                         }
                                         else
                                         {
                                             $clientAlready=1;
                                            // echo"in client already"."\n";
                                             // $insertRow = false;
