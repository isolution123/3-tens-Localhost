...
class TCPDF {
	...
	public function Footer() {
		...
		//Print page number
		if ($this->getRTL()) {
            //$image_file = base_url('assets/users/img/logo-footer.png');
            //$this->Image($image_file, 11, 241, 189, '', 'PNG', '', 'T', false, 300, '', false, false, 0, false, false, false);
			$this->SetX($this->original_rMargin);
            $this->Cell(0, 0, $pagenumtxt, 'T', 0, 'L');
            $this->Cell(0, 0, 'Powered by 3tense                                                                                                                              '.date("d-M-Y"), 'T', 0, 'R');
            
            
            
		} else {
            //$image_file = base_url('assets/users/img/logo-footer.jpg');
            //$this->Image($image_file, 11, 241, 189, '', 'JPG', '', 'T', false, 300, '', false, false, 0, false, false, false);
			$this->SetX($this->original_lMargin);
            $this->Cell(0, 0, '  Powered by 3tense                                                                                                                              '.date("d-M-Y"), 'T', 0, 'L');
	...
	protected function setHeader() {
        ...
        if($this->page == 1) {
            ...
            if ($this->rtl) {
                $this->SetXY($this->original_rMargin, 0);
            } else {
                $this->SetXY($this->original_lMargin, 0);
            }

            //restore position
            if ($this->rtl) {
                $this->SetXY($this->original_rMargin, 10);
            } else {
                $this->SetXY($this->original_lMargin, 10);
            }
        }
