      ...
      <div class="container body">
          ...
          <div class="verticalcenter" style="top: 35%;" align="center">
          	...
          	<div class="panel panel-primary">
                ...
                <div class="form__field">
                  <!-- <input type="radio" name="doc" value="adhar"> Adhar Card
                </div>
                <div class="form__field">
                  <input type="radio" name="doc" value="pan"> Pan Card
                </div>
                <div class="form__field">
                  <input type="radio" name="doc" value="pass"> Passport</br>
                </div>
                <div class="form__field">
                  <input type="radio" name="doc" value="ration"> Ration Card
                </div>
                <div class="form__field">
                  <input type="radio" name="doc" value="voterid"> Voter Id
                </div>
                <div class="form__field">
                  <input type="radio" name="doc" value="ITreturn"> Income Tax Return</br>
                </div>
                <div class="form__field">
                  <input type="radio" name="doc" value="ebill"> Electricity Bill -->
