    ...
    ************************************************************************************************ -->
    <div id="login-page">
        <div class="container">
            ...
            echo form_open('super_admin/SuperAdminUsers/login', $attributes); ?>
		        ...
		        <div class="login-wrap">
		            ...
		            <button class="btn btn-theme btn-block" name="btn_login" value="Login" type="submit">
    ...
    <script>
        $.backstretch("<?php echo base_url();?>assets/admin/img/login-bg.jpg", {speed: 500});
    </script>
    </body>
</html>
