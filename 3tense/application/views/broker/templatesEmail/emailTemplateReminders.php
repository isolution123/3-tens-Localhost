					...
					<tr>
						<td width="100%">
							<table bgcolor="#ffffff" border="0" cellpadding="0" cellspacing="0" class="table_scale" width="600"> <!-- bgcolor="#757f83" -->
								<tr width="100%"> <td width="100%"><span style="font-weight: 300;font-family: Times, sans-serif; color:#757f83; font-size:150%; line-height:34px; mso-line-height-rule: exactly; margin-left:10px; text-transform: capitalize;">Hi <br/><b style="margin-left:10px;">' . $result[0]->client_name . ',</b></span></td></tr>								
								<tr><td >&nbsp;</td></tr>
					...
					<tr>
						<td width="100%">
							<table bgcolor="#FFFFFF" border="0" cellpadding="0" cellspacing="0" class="table_scale" width="600">
								<tr>
									<td width="100%">
										<table border="0" cellpadding="0" cellspacing="0" width="600" style="border-bottom: 1px solid #d9d9d9;">
											<tbody>
							...
							<table class="table_scale" cellspacing="0" cellpadding="0" width="600" style="border-top:solid 1px;" bgcolor="#FFFFFF" align="center">
								...
								<!-- 	<td width="100%" height="40">&nbsp;</td> -->
    								<td align="left" width="15%" class="center" valign = "center" style="border-top:solid 1px; border-color:#d9d9d9; padding-bottom: 2px; padding-top: 2px;padding-left: 7px; font-weight: 500;font-family:  Helvetica, Arial, sans-serif; color:#757f83; font-size:100%; line-height:34px; mso-line-height-rule: exactly;"><span>
    													
    												<br/><span><center>Please feel free to contact us on <b>'.$broker_result->mobile.'</b> regarding this email, in case of any issues or queries.  &nbsp;&nbsp;&nbsp; :</center> </span>
