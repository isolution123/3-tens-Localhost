    ...
    <div id='wrap'>
        <div id="page-heading">
            <ol class="breadcrumb">
                ...
                <li>Imports</li>
                <li class="active">Import Holding APC</li>
            </ol>
            <h1>Import Holding APC</h1>
        </div>
    </div>
    <div class="container">
        <form action="<?php echo base_url('broker/Equity/import_holding_apc') ?>" id="import_form" method="post" class="form-horizontal row-border" enctype="multipart/form-data">
            <div class="panel panel-midnightblue">
                <div class="panel-heading">
                    <h4>Import Holding APC</h4>
                </div>
                <div class="panel-body collapse in">
                    <div class="alert alert-info">
                        <button type="button" class="close" data-dismiss="alert">&times;</button>
                        Import Holding APC for Equity<br/>
                        Please Note: The Excel Sheet must contain 'Party Code', 'Script Code','Total Quantity','Total APC'  columns as mentioned to import<br/><br/>
                        <a href="<?=base_url('uploads/imports/Holding-APC-import.xlsx');?>" id="demoFile" class="alert-link"><i class="fa fa-file-excel-o"></i> Download our Demo Import File</a><br/>
                        Note: Please delete the Row 2 data in the Excel file before adding and importing your data.
                    </div>
                    <div class="row">
                        <input type="hidden" name="Import" value="Import">
                        <div class="form-group">
                            <label for="import_holding_apc" class="col-sm-2 control-label">File Upload</label>
                                ...
                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-addon btn btn-default btn-file">
                                            ...
                                            <input type="file" tabindex="1" name="import_holding_apc" id="import_holding_apc">
                                        </span>
