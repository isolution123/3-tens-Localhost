                            ...
                            <div class="form-group">
                              ...
                              <div class="col-md-6 addon" id="addon">
                                    <div class="col-md-9 no-border">
                                          <table>
                                            <tr><td><label style="color:blue;">Add-on</label></td><td><label><input  type="checkbox" id="select_all" value="selet_all" tabindex="4"   /> Select All</td></label></tr>
                                            <tr><td style="padding-right:10px;" >
                                                <label><input  type="checkbox" id="client_summary" class="select_all" value="client_summary"  name="Client"/> Client Summary</label></td>
                                                <td style="padding-right:10px;"><label><input  type="checkbox" id="typewise" value="typewise" class="select_all"> Fund  Typewise Summary</label></td>
                                                </tr>
                                            <tr><td style="padding-right:10px;">
                                                <label><input  type="checkbox" id="net_investmet" class="select_all" value="net_investmet"> Net Investmet</label></td>
                                                <td style="padding-right:10px;"><label><input  type="checkbox" id="scheme_summary" value="scheme_summary" class="select_all"> Scheme / AMC wise Summary</label></tr>
                                          </table>
                                    </div>
                              </div>
                            </div>
                    ...
                    <div class="panel-body collapse in" id="broker_div">
                        <div class="row">
                            <div class="form-group">
                              ...
                              <div class="col-md-1">
                                  <div class="form-group" style="text-align: center">
                                    <button type="button" class="btn btn-success ladda-button" tabindex="9" id="broker_submit" data-style="expand-right"><i class="fa fa-file-text-o"></i> <span class="ladda-label">Generate Report</span></button>
                                </div>
          ...
          var  net_investmet;
            ...
            if ((famName != null && famName.length != 0) || (client_id != null && client_id.length != 0))
            {
                  ...
                  $.ajax({
                      ...
                      type: 'post',
                      data: {'famName': famName, 'client_id': client_id,'type':type,'client_summary':client_summary,'typewise':typewise,'scheme_summary':scheme_summary,'net_investmet':net_investmet,'from_date':from_date,'to_date':to_date,
