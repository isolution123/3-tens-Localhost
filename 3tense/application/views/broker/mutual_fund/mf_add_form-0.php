                    ...
                    <div class="panel-body collapse in">
                        ...
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-md-4 add-new-btn">
                                    <select name="mutual_fund_scheme" class="populate" required="required" id="mutual_fund_scheme" style="width: 100%" tabindex="8">
                                        <option disabled selected value="">Select Mutual Fund Scheme</option>
                                        <?php foreach($mfSchemes as $row):?>
...
<script type="text/javascript">
    $(function() {
        ...
        $('#folio_number, #mutual_fund_scheme').change(function(){
            var fol_num = $('#folio_number').val();
            var mf_scheme = $('#mutual_fund_scheme').val();
        ...
        $("#mutual_fund_scheme, #purchase_date").change(function() {
            var schemeID = $("#mutual_fund_scheme").val();
