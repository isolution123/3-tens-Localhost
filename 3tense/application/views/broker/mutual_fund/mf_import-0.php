...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $("#fund_val_btn").on("click", function() {
            bootbox.confirm("Do you really want to calculate Valuation of Mutual Funds? Please note that this will take some time to finish, so please be patient.", function(result) {
                if(result) {
                    ...
                    $.ajax({
                        url: "<?php echo site_url('broker/Mutual_funds/mutual_fund_valuation');?>",
                        type: 'post',
                        ...
                        success: function(data)
                        {
                            ...
                            if(data['type'] == 'success') {
                                ...
                                $("#note").html("Valuation did not complete successfully. Please try again.");
                            }
                        },
