                              ...
                              <div   class="col-md-6">
                                ...
                                <div class="col-md-7  no-border">
                                    <select name="type" class="populate" id="type" style="width: 100%" tabindex="3" >
                                       ...
                                       <option value="clientwise_summary" selected>Clientwise Summary</option>
                                       <?php
                                        //show yearwise report option only to iSolutions and V-Financial services
                                        if($this->session->userdata('broker_id')=='0004' ||$this->session->userdata('broker_id')=='0204' || $this->session->userdata('broker_id')=='0009' || $this->session->userdata('broker_id')=='0174' || $this->session->userdata('broker_id')=='0196')
                                        {
                                            echo '<option value="clientwise_summary_by_year">Yearwise Summary</option>';
                                            echo '<option value="scheme_group_type_wise">Typewise Summary</option>';
                                        }
                                       ?>
                                       
                                       <option value="schemewise_detail" >Schemewise Detail</option>
                                ...
                                <div class="col-md-7 no-border">
                                    <select name="broker_rep_type" class="populate" id="broker_rep_type" style="width: 100%" tabindex="8" >
                                       ...
                                       <?php
                                        ...
                                        || $this->session->userdata('broker_id')=='0063'
                                        || $this->session->userdata('broker_id')=='0180')
                                        {
    ...
    $(function()
    {
        ...
        $("#mf_submit").click(function()
        {
          ...
          var summart=null;
            ...
            var client_id = $('#client_id').val().join(',');
        ...
        $('#famName').change(function()
        {
            ...
            {
                $("#client_id").select2({placeholder: 'Select Client', maximumSelectionSize: 10});
            }
        });
