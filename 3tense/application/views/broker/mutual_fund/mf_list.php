        ...
        <div id="page-heading">
            ...
            <div class="options">
                <div class="btn-toolbar">
                    <a class="btn btn-default ladda-button" href="<?php echo base_url('broker/Mutual_funds/mf_report');?>">Mutual Fund Report</a>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
       ...
       $('#transaction .dataTables_filter input')
        ...
        table.columns().eq( 0 ).each( function ( colIdx ) {
            $('input', table_val.column( colIdx ).footer() ).off('keyup change').on('keyup change', function (e) {
                if (e.which == 13 ) {
        ...
        table_val.columns().eq( 0 ).each( function ( colIdx ) {
            $('input', table_val.column( colIdx ).footer() ).off('keyup change').on('keyup change', function (e) {
                if (e.which == 13) {
                    table_val.column( colIdx ).search( this.value ).draw();
                }
            });
        });
    ...
    function ajax_mf_list_val() {
        ...
        if(broker_id=='0004'||broker_id=='0204'|| broker_id=='0009' || broker_id=='0174' || broker_id=='0196' )
        {
             cols.push({ "data": "from_file" });
        }
