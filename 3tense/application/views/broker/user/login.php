...
<div class="verticalcenter" style="top: 35%;">
    <a href="<?php echo base_url('broker'); ?>"><img src="<?php echo base_url(); ?>assets/users/img/logo-big.png" alt="Logo" class="brand" style="padding-bottom: 0px !important;" /></a>
	<div class="panel panel-primary">
		<div class="panel-body">
			<h4 class="text-center" style="margin-bottom: 25px;">Login to get started or <a href=""#"> Sign Up11</a></h4>
            ...
            <?php echo $this->session->flashdata('msg'); ?>
                <div class="panel-footer">
                    <a href="<?php echo base_url('broker/forget');?>" class="pull-left btn btn-link" style="padding-left:0">Forgot password?</a>
