            ...
            <form action="#" id="ins_report_form" method="post" class="form-horizontal row-border">
                <div class="panel panel-midnightblue">
                    <div class="panel-heading">
                        <h4>Real Estate Report Info</h4>
                    </div>
                    <div class="panel-body collapse in">
                        <div class="row">
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="famName">Family Name</label>
    ...
    $(function() {
        ...
        $("#ins_submit").click(function(){
            ...
            if ((famName != null && famName.length != 0) || (client_id != null && client_id.length != 0)) {
                $.ajax({
                    url: "<?php echo site_url('broker/Real_estate/get_re_report');?>",
                    type: 'post',
                    ...
                    success: function(data)
                    {
                        if(data['Status'])
                        {
                            window.open("<?php echo site_url('broker/Reports/get_re_report');?>", '_blank')
                        }
                        else
                        {
