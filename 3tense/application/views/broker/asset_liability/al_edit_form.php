            ...
            <div class="panel panel-primary">
                <div class="panel-heading" style="height: auto">
                    <ul class="nav nav-tabs">
                        <?php if($asset_liab->transaction_type == 'asset'):?>
                            <li class="active">
                                <a href="#asset" tabindex="7" data-toggle="tab">Asset</a>
                            </li>
                            <li>
                                <a href="javascript:void(0)" tabindex="8">Liability</a>
                            </li>
                        <?php else: ?>
                            <li>
                                <a href="javascript:void(0)" tabindex="7">Asset</a>
                            </li>
                            <li class="active">
                                <a href="#liability" tabindex="8" data-toggle="tab">Liability</a>
                            </li>
                        <?php endif;?>
                    </ul>
                </div>
                                ...
                                <div class="panel-body collapse in">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" name="goal"  class="form-control" id="goal" tabindex="1"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" name="ref_number" readonly class="form-control" id="ref_number"
                                                     value="<?php echo isset($asset_liab->ref_number)?$asset_liab->ref_number:'';?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-4 control-label">Folio No.</label>
                                            <div class="col-sm-8">
                                                <input type="text" name="folio_no"   class="form-control" id="folio_no" tabindex="2" value="<?php echo isset($asset_liab->folio_no)?$asset_liab->folio_no:'';?>">
                                            </div>
                                        </div>
                                        <div class="form-group"><!--test-->
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" name="start_date" readonly class="form-control"
                                                    data-inputmask="'alias':'date'" id="start_date" 
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" name="end_date" class="form-control date" required="required"
                                                    data-inputmask="'alias':'date'" id="end_date" tabindex="3"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text"  name="cease_date"  class="form-control date" data-inputmask="'alias':'date'" id="cease_date" tabindex="4" value="<?php echo isset($asset_liab->cease_date)?$asset_liab->cease_date:'';?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" name="frequency" readonly class="form-control" id="frequency" 
                                                    value="<?php echo isset($asset_liab->frequency)?$asset_liab->frequency:'';?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8 input-group">
                                                <input type="text" name="rate_of_return" readonly class="form-control" id="rate_of_return"
                                                     value="<?php echo isset($asset_liab->rate_of_return)?$asset_liab->rate_of_return:'';?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <textarea name="narration" class="form-control" id="narration" tabindex="5" style="height: 109px"><?php echo isset($asset_liab->narration)?$asset_liab->narration:'';?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
