                                ...
                                <div class="panel-body collapse in">
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" name="end_date"  class="form-control date" data-inputmask="'alias':'date'" id="end_date" tabindex="18" value="<?php date('d/m/Y');?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-4 control-label">Cease Date</label>
                                            <div class="col-sm-8">
                                                <input type="text" name="cease_date"  class="form-control date" data-inputmask="'alias':'date'"  id="cease_date" tabindex="19" value="<?php date('d/m/Y');?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
