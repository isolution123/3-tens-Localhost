                    ...
                    <div class="panel-body collapse in">
                        <div class="row">
                            <div class="form-group">
                                ...
                                <input type="hidden" name="hIsUpdateMaturity" id="hIsUpdateMaturity" value="1" />
                                    ...
                                    <div class="panel-body collapse in">
                                        <div class="col-sm-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="hidden" name="paidup_date" required="required" tabindex="8" class="form-control" id="paidup_date" value="<?php echo isset($insurance[0]->paidup_date)?$insurance[0]->paidup_date:'';?>">
                                                    <div class="col-sm-8">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="hidden" name="maturity_date" required="required" tabindex="9" readonly class="form-control" id="maturity_date" value="<?php echo isset($insurance[0]->maturity_date)?$insurance[0]->maturity_date:'';?>">
                                                    <div class="col-sm-8">
...
var table; var matInfo;
    $(function() {
        ...
        if($("#mode option:selected").text() == "Single") {
            $("#ppt").prop("disabled",true);
            $("#ppt").val(1);
            $("#paidup_date").val($("#commence_date").val());
        }
        ...
        var url = "<?php echo site_url('broker/Clients/get_clients_broker_dropdown_wise');?>";
    ...
    function ins_submit()
    {
        ...
        if(valid)
        {
            ...
            if($('input[name="mat_type"]:checked').val()=='Regular')
            {
                var formData=$('#client_form, #ins_form, #add_form').serialize();
                
                bootbox.confirm({
                                    message: 'Are you sure you want to delete this maturity details?',
                                    buttons: {
                                        confirm: {
                                        label: 'Yes',
                                    ...
                                    if(result)
                                    {
                                       formData= formData.replace("&hIsUpdateMaturity=0", "&hIsUpdateMaturity=1");
                                       $.ajax({
                                    ...
                                    {
                                        formData=formData.replace("&hIsUpdateMaturity=1", "&hIsUpdateMaturity=0");
                                      $.ajax({
                                        url: '<?php echo site_url('broker/Insurances/edit_ins');?>',
                                        type: 'post',
                                        data: formData,
...
function addULMaturity(matAmt, polNum, matDate)
{
    ...
    function mat_list(policyNum) {
        ...
        if(policyNum == undefined || policyNum == "") {
