            ...
            <div class="panel panel-midnightblue">
                ...
                <div class="panel-body collapse in">
                    <div class="alert alert-info">
                        ...
                        <a href="<?=base_url('uploads/imports/Client-Import.xls?1=1');?>" id="demoFile" class="alert-link"><i class="fa fa-file-excel-o"></i> Download our Demo Import File</a><br/>
                    ...
                    <div class="row">
                        ...
                        <div id='rta_list'class="col-sm-6" >
                          <select class="form-control select2"  name="rta_list" id="rta_list" required="required">
                              <option value=" " selected disabled="true">Select Type of Client Data(Excel/Dbf File)</option>
                              <option value="cl_excel">Import Client Details (Excel/Dbf) file</option>
                              <option value="cams_excel">Import Client Details From CAMS (Excel/Dbf) file</option>
                              <option value="karvy_excel">Import Client Details From KARVY (Excel/Dbf) file</option>
                              <option value="frank_excel">Import Client Details From FRANKLIN (Excel/Dbf) file</option>
                              <option value="sundaram_excel">Import Client Details From SUNDARAM (Excel/Dbf) file</option>
                              <option value="nj_excel">Import NJ Client Details Excel file</option>   <!--pallavi  2017-06-15-->
                          </select>
                        </div>
                           <br><br>
