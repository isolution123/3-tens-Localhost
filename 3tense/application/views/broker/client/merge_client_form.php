            ...
            <form action="<?php echo base_url('broker/Clients/clients_merge') ?>" id="mf_form" method="post" class="form-horizontal row-border" data-validate="parsley" >
                <div class="panel panel-midnightblue control-form">
                    ...
                    <div class="panel-body collapse in">
                        ...
                        <div class="row">
                          <table cellspacing="5" cellpadding="5" border="0" style="display:none;">
                          <tbody><tr>
  <td><a id="byfname" tabindex="4" class="btn btn-success" style="margin-top: 20px;">FirstName + DOB </a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  <!--<a id="reset_list" tabindex="4" class="btn btn-success" style="margin-top: 20px; width:100px">Reset</a></td>-->
