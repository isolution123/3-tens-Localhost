                                ...
                                <div class="tab-pane active form-no-border" id="personal">
                                    <form action="<?php echo base_url('broker/Clients/save')?>" class="form-horizontal row-border" method="post" data-validate="parsley" id="validate-form" enctype="multipart/form-data">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            if($this->session->userdata('user_id') == $this->session->userdata('broker_id') && ($this->session->userdata('broker_id')=='0004' || $this->session->userdata('broker_id')=='0009' || $this->session->userdata('broker_id') == '0174' || $this->session->userdata('broker_id') == '0196'))
                                            {?>
                                                <div class="form-group">
                                                    <label for="radio" class="col-sm-3 control-label">App Access?</label>
                                                    <div class="col-sm-6">
                                                        <div class="radio block">
                                                            <label><input type="radio" name="app_access" value="1" <?php if(isset($client_info->app_access) && ($client_info->app_access === '1')) { ?> checked="checked" <?php } ?>> Yes</label><span style="margin-right: 30px;"></span>
                                                            <label><input type="radio" name="app_access" value="0" <?php if(isset($client_info->app_access) && ($client_info->app_access === '0')) { ?> checked="checked" <?php } ?>> No</label>
                                                        </div>
                                                    </div>
                                                </div>
                                            <?php
                                        ...
                                        <div class="col-md-12">
                                            <div class="tab-container tab-left tab-danger">
                                                <ul class="nav nav-tabs">
                                                    ...
                                                    <?php
                                            //show yearwise report option only to iSolutions and V-Financial services
                                            if($this->session->userdata('user_id') == '0006')
                                            //$this->session->userdata('broker_id') && ($this->session->userdata('broker_id')=='0004' || $this->session->userdata('broker_id')=='0009' || $this->session->userdata('broker_id') == '0174' || $this->session->userdata('broker_id') == '0196'))
                                            {?>
                                                    <li><a href="#BSCAccount" data-toggle="tab">BSC Account Details</a></li>
                                                    <?php } ?>
                                                </ul>
                                                <div class="tab-content">
