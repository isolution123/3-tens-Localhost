                    ...
                    <div class="panel-body collapse in">
                        <div class="row">
                            <div class="form-group">
                                ...
                                <input type="hidden" name="hNominee" id="hNominee" value="<?= $fd[0]->nominee_id; ?>" />
                    ...
                    <div class="panel-body collapse in">
                        ...
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-md-4  no-border">
                                    <select class="form-control" name="nominee" id="nominee" required="required" tabindex="8">
                                        <option disabled selected value="">Select Nominee</option>
                    ...
                    <div class="panel-body collapse in">
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-md-4 no-border add-new-btn">
                                    <select name="inv_bank_id" class="populate" required="required" id="inv_bank_id" style="width: 80%" tabindex="15">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" name="inv_cheque_date" class="form-control date" tabindex="19" id="inv_cheque_date"
                                           data-inputmask="'alias':'date'" value="<?php echo isset($fd[0]->inv_cheque_date)?$fd[0]->inv_cheque_date:'';?>">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                    ...
                    <div class="panel-body collapse in">
                        <div class="row">
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Bank Name</label>
                                <div class="col-md-4 no-border add-new-btn">
                                    <select name="maturity_bank_id" class="populate" required="required" id="maturity_bank_id" style="width: 80%" tabindex="21">
                                        <option disabled selected value="">Select Bank</option>
                                        <?php /*foreach($bank as $row):?>
                                            <option value='<?php echo $row->bank_id; ?>'><?php echo $row->bank_name; ?></option>
                                        <?php endforeach;*/ ?>
                        ...
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-md-4  no-border">
                                    <select name="maturity_payout_id" class="populate" required="required" id="maturity_payout_id" style="width: 100%" tabindex="24">
...
function get_nominee()
{
    $.ajax({
        ...
        success:function(data)
        {
            ...
            $("#nominee").prepend("<option value=''>Select Nominee</option>");
