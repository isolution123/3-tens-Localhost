        ...
        <div class="container">
                    ...
                    <div class="panel-body collapse in">
                        ...
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-md-4 no-border">
                                    <input type="text" name="cheque_date" tabindex="8" value="<?php echo date('d/m/Y')?>" class="form-control mask datepicker" id="cheque_date" data-inputmask="'alias':'date'" >
                                </div>
                    ...
                    <div class="panel-body collapse in">
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-md-4 no-border">
                                    <div class="radio block"><label><input type="radio" name="withdraw_from" id="radio-equity" value="Equity"> Equity</label></div>
                                    <div class="radio block"><label><input type="radio" name="withdraw_from" id="radio-mf" value="Mutual Funds"> Mutual Funds</label></div>
                                    <div class="radio block"><label><input type="radio" name="withdraw_from" value="Insurance"> Insurance</label></div>
                                    <div class="radio block"><label><input type="radio" name="withdraw_from" value="Fixed Income"> Fixed Income</label></div>
                                    <div class="radio block"><label><input type="radio" name="withdraw_from" value="Commodity"> Commodity</label></div>
                                    <div class="radio block"><label><input type="radio" name="withdraw_from" value="Real Estate"> Real Estate</label></div>
                                    <div class="radio block"><label><input type="radio" name="withdraw_from" checked="checked" value="Others"> Others</label></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="panel-body collapse in info-body" id="mf-body" style="display: none;">
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-md-4 no-border">
                                    <div class="radio block"><label><input type="radio" name="mf_type" checked="checked" value="Redemption"> Redemption</label></div>
                                    <div class="radio block"><label><input type="radio" name="mf_type" value="Dividend"> Dividend</label></div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="bottom-row navbar-fixed-bottom">
                <div class="col-sm-12 bottom-col">
                    ...
                    <button type="button" id="edit" tabindex="35" onclick="editForm('<?php echo base_url("broker/Withdraw_funds/edit_form");?>', $('#withdrawFundID').val())"  data-style="expand-left" class="btn btn-primary bottom-btn ladda-button"><i class="fa fa-pencil"></i> Edit</button>
                    ...
                    <button type="button" id="cancel" tabindex="38" onclick="window.location.href = '<?php echo base_url('broker/Withdraw_funds');?>'"  data-style="expand-left" class="btn btn-warning bottom-btn ladda-button"><i class="fa fa-ban"></i> Cancel</button>
                </div>
            </div>
        </div> <!-- container -->
    </div> <!--wrap -->
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        $('#radio-equity').on('click', function() {
            ...
            //$("#trading_broker_id").attr("required","required");
            //$("#client_code").attr("required","required");
    ...
    function fund_submit()
    {
        ...
        if(valid && dateValid)
        {
            ...
            $.ajax({
                url: '<?php echo site_url('broker/Withdraw_funds/withdraw_funds');?>',
                type: 'post',
                data: form_data,
                dataType: 'json',
                success:function(data)
