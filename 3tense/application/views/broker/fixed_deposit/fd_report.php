    ...
    $(function() {
        ...
        $("#ins_submit").click(function(){
            ...
            if ((famName != null && famName.length != 0) || (client_id != null && client_id.length != 0)) {
                $.ajax({
                    url: "<?php echo site_url('broker/Fixed_deposits/get_fd_report');?>",
                    type: 'post',
                    ...
                    success: function(data)
                    {
                        if(data['Status'])
                        {
                            window.open("<?php echo site_url('broker/Reports/get_fd_report');?>", '_blank')
                        }
                        else
                        {
