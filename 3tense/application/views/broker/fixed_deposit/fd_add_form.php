                    ...
                    <div class="panel-body collapse in">
                        ...
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-md-4  no-border">
                                      <input type="text" name="nominee"  tabindex="18" class="form-control" id="nominee">
                                </div>
                    ...
                    <div class="panel-body collapse in">
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-md-4  no-border add-new-btn">
                                    <select name="inv_bank_id" class="populate" id="inv_bank_id" style="width: 80%" tabindex="26">
                    ...
                    <div class="panel-body collapse in">
                        <div class="row">
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Bank Name</label>
                                <div class="col-md-4 no-border add-new-btn">
                                    <select name="maturity_bank_id" class="populate" id="maturity_bank_id" style="width: 80%" tabindex="32">
                                        <option disabled selected value="">Select Bank</option>
                                        <?php /*foreach($bank as $row):?>
                                            <option value='<?php echo $row->bank_id; ?>'><?php echo $row->bank_name; ?></option>
                                        <?php endforeach;*/ ?>
                        ...
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-md-4  no-border">
                                    <select name="maturity_payout_id" class="populate" id="maturity_payout_id" style="width: 100%" tabindex="35">
