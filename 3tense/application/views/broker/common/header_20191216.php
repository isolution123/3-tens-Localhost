            ...
            <ul class="acc-menu" id="sidebar">
                ...
                <li><a href="javascript:;"><i class="fa fa-archive"></i> <span>Masters <?php //<img src="https://3tense.com/assets/users/images/icon_new.gif" width="25px" height="20px" alt="whats new"/>?></span></a>
                    <ul class="acc-menu">
                        ...
                        ?>
                        <?php
                        if($this->session->userdata('user_id') == $this->session->userdata('broker_id') && ($this->session->userdata('broker_id') == '0004' || $this->session->userdata('broker_id') == '0009' || $this->session->userdata('broker_id') == '0174'))
                        {
                        ?>
