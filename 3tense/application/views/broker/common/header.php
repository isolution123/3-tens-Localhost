        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-6 col-sm-2">
                    <a href="<?php echo site_url('broker/Mutual_funds/mf_report')?>" class="shortcut-tiles tiles-midnightblue">
                ...
                <div class="col-xs-6 col-sm-2">
                    <a href="<?php echo site_url('broker/Insurances/ins_report')?>" class="shortcut-tiles tiles-brown">
                        <div class="tiles-body">
                            <div class="pull-left"><i class="fa fa-file-text"></i></div>
                        </div>
                        <div class="tiles-footer">
                 ...
                 <div class="col-xs-6 col-sm-2">
                    <a href="<?php echo site_url('broker/Final_reports/ledger_report')?>" class="shortcut-tiles tiles-brown">
                        <div class="tiles-body">
                            <div class="pull-left"><i class="fa fa-file-text"></i></div>
                        </div>
                        <div class="tiles-footer">
                ...
                <div class="col-xs-6 col-sm-2">
                    <a href="<?php echo base_url('broker/Final_reports/cash_flow_report'); ?>" class="shortcut-tiles tiles-grape">
                        <div class="tiles-body">
                            <div class="pull-left"><i class="fa fa-file-text"></i></div>
                        </div>
                        <div class="tiles-footer">
                ...
                <div class="col-xs-6 col-sm-2">
                    <a href="<?php echo site_url('broker/Final_reports/summary_report')?>" class="shortcut-tiles tiles-primary">
                        <div class="tiles-body">
                            <div class="pull-left"><i class="fa fa-file-text"></i></div>
                        </div>
                        <div class="tiles-footer">
                ...
                <div class="col-xs-6 col-sm-2">
                    <a href="<?php echo site_url('broker/Clients')?>" class="shortcut-tiles tiles-inverse">
                        <div class="tiles-body">
            ...
            <ul class="acc-menu" id="sidebar">
                ...
                <li><a href="javascript:;"><i class="fa fa-archive"></i> <span>Masters <?php //<img src="https://3tense.com/assets/users/images/icon_new.gif" width="25px" height="20px" alt="whats new"/>?></span></a>
                    <ul class="acc-menu">
                        ...
                        {
                        ?>
                                <li><a href="<?php echo base_url('broker/Mutual_fund_schemes/updatenav'); ?>"><span>Update NAV</span></a></li>
                                   <?php } ?>
                                   
                                   <?php
                if($this->session->userdata('broker_id') == '0004' ||$this->session->userdata('broker_id') == '0204' || $this->session->userdata('broker_id') == '0180')
                {
                ?>
                 <li><a href="<?php echo base_url('broker/Mutual_funds/MFDuplicateTrancation'); ?>"><span>MF Duplicate Trancation</span></a></li>
                ...
                <?php 
                        ...
                        <?php
                        if($this->session->userdata('broker_id') == '0004' ||$this->session->userdata('broker_id') == '0204' || $this->session->userdata('broker_id') == '0009')
                        {
                        ?>
                        <li><a href="<?php echo base_url('broker/Scheme_Trigger');?>"><span>Scheme Trigger</span></a></li>
                        
                          <?php
                          if($this->session->userdata('user_id') =='0006' ||($this->session->userdata('user_id')==$this->session->userdata('broker_id') && ($this->session->userdata('broker_id') == '0004' )))
                        {
                        ?>
                        
                        <li><a href="<?php echo base_url('broker/Bse_Password');?>"><span>BSE Password</span></a></li>
                        <li><a href="<?php echo base_url('broker/Nfo_detail/index');?>"><span>Upload NFO</span></a></li>
                        ...
                        ?>
                        <?php
                        if($this->session->userdata('user_id')=='0202' || ($this->session->userdata('user_id') == $this->session->userdata('broker_id') && ($this->session->userdata('broker_id') == '0004'  || $this->session->userdata('broker_id') == '0009' || $this->session->userdata('broker_id') == '0174')))
                        {
                        ?>
                        <li><a href="<?php echo base_url('broker/AppImages');?>"><span>App Images</span></a></li>
                        <?php
                        }
                        ...
                        {
                        ?>
                        <li><a href="<?php echo base_url('broker/Notifications');?>"><span>Send Push Notifications</span></a></li>
                        <?php
                        }
                        ...
                        {
                        ?>
                        <li><a href="<?php echo base_url('broker/AppUsage');?>"><span>App Usage Report</span></a></li>
                        <?php
                        }
                        ?>
                    </ul>
                    ...
                    <ul class="acc-menu">
                        ...
                        <li><a href="javascript:;"><span>Mutual Fund <?php //<img src="https://3tense.com/assets/users/images/icon_new.gif" width="25px" height="20px" alt="whats new"/>?></span></a>
                            <ul class="acc-menu">
                                ...
                                <?php
                                   if( $this->session->userdata('user_id') =='0183'  || $this->session->userdata('user_id') =='0185'|| $this->session->userdata('user_id') =='0013' || $this->session->userdata('user_id') =='0006')
                                {
                                ?>
                                <li><a href="<?php echo base_url('broker/SIP/MonthlySIPBook'); ?>"><span>Monthly SIP Book</span></a></li>
                                <?php }?>
                        ...
                        <li><a href="javascript:;"><span>Share Equity</span></a>
                            ...
                            <li><a href="<?php echo base_url('broker/Equity/import_holding_apc'); ?>"><span>Holding - APC</span></a></li>
                        <?php
                        }?>
                        ...
                        <?php
                          if($this->session->userdata('user_id') =='0183' ||  $this->session->userdata('user_id') =='0188' || $this->session->userdata('user_id') =='0006' ||($this->session->userdata('user_id')==$this->session->userdata('broker_id') && ($this->session->userdata('broker_id') == '0004' )))
                        {
                            
                        ?>
                         <li><a href="javascript:;"><span>BSE</span></a>
                            <ul class="acc-menu">
                            <li><a href="<?php echo base_url('broker/Mutual_fund_schemes/import'); ?>"><span>Import Bse Scheme</span></a></li>
                            <li><a href="<?php echo base_url('broker/Mutual_fund_schemes/import_client'); ?>"><span>Import Bse Client</span></a></li>
                            <li><a href="<?php echo base_url('broker/Mutual_fund_schemes/import_client_mandate'); ?>"><span>Import Bse Mandate</span></a></li>
                            <li><a href="<?php echo base_url('broker/Mutual_fund_schemes/import_client_folio'); ?>"><span>Import MF Folio</span></a></li>
                            <li><a href="<?php echo base_url('broker/Mutual_fund_schemes/Import_FD_Rate'); ?>"><span>Import FD Rate</span></a></li>
                           </ul>
                        </li>  
                        <?php
                        }?>
