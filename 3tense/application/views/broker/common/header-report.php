...
<body class="<?php if (isset($_COOKIE["fixed-header"])) echo ' static-header'; ?>">
    <?php /*<div id="headerbar">
        <div class="container">
            <div class="row">
                ...
                <div class="col-xs-6 col-sm-2">
                    <a href="<?php echo site_url('broker/Equity/add_form')?>" class="shortcut-tiles tiles-grape">
                        <div class="tiles-body">
                ...
                <div class="col-xs-6 col-sm-2">
                    <a href="<?php echo site_url('broker/Mutual_funds/add_form')?>" class="shortcut-tiles tiles-midnightblue">
                        <div class="tiles-body">
    ...
    <header class="navbar navbar-inverse <?php if (isset($_COOKIE["fixed-header"])) {echo 'navbar-static-top';} else {echo 'navbar-fixed-top';} ?>" role="banner">
        ...
        <?php /*<div class="navbar-header pull-left">
        ...
        <ul class="nav navbar-nav pull-right toolbar">
        		...
        		<ul class="dropdown-menu userinfo arrow">
        			...
        			<li class="userlinks">
        				<ul class="dropdown-menu">
        					...
        					<li><a href="#" onclick="eod()">End of Day <i class="pull-right fa fa-sign-out "></i></a></li>
        					<li class="divider"></li>
        	...
        	<li class="dropdown">
                ...
                ?>
        		<a href="#" class="hasnotifications dropdown-toggle" data-toggle='dropdown'><i class="fa fa-bell"></i><span class="badge"><?php echo $count_reminder; ?></span></a>
        		<ul class="dropdown-menu notifications arrow">
        			<li class="dd-header">
        				<span>Today you have <?php echo $count_reminder;?> reminder(s)</span>
        			</li>
    ...
    <div id="page-container">
        <!-- BEGIN SIDEBAR -->
        <?php /*<nav id="page-leftbar" role="navigation">
                <!-- BEGIN SIDEBAR MENU -->
            <ul class="acc-menu" id="sidebar">
                ...
                <li><a href="javascript:;"><i class="fa fa-archive"></i> <span>Masters</span></a>
                    <ul class="acc-menu">
                        <li><a href="javascript:;"><span>Insurance</span></a>
                            <ul class="acc-menu">
                                <li><a href="<?php echo base_url('broker/Premium_types');?>"><span>Assets Allocation</span></a></li>
                        ...
                        <li><a href="<?php echo base_url('broker/Clients');?>"><span>Client</span></a></li>
                ...
                <li><a href="javascript:;"><i class="fa fa-upload"></i> <span>Imports</span></a>
                    <ul class="acc-menu">
                        <li><a href="javascript:;"><span>Insurance</span></a>
                            <ul class="acc-menu">
                                <li><a href="<?php echo base_url('broker/Insurances/ins_fund_import');?>"><span>Fund Option</span></a></li>
                                <li><a href="<?php echo base_url('broker/Insurances/ins_stake_import');?>"><span>Real Stakes</span></a></li>
                            </ul>
                        </li>
                        <li><a href="javascript:;"><span>Mutual Fund</span></a>
                            <ul class="acc-menu">
                                <li><a href="<?php echo base_url('broker/Mutual_funds/mutual_fund_import'); ?>"><span>MF Transaction</span></a></li>
                                <li><a href="<?php echo base_url('broker/Mutual_funds/nav_import'); ?>"><span>NAV</span></a></li>
                            </ul>
                        </li>
                        <li><a href="javascript:;"><span>Share Equity</span></a>
                            <ul class="acc-menu">
                                ...
                                <?php /*<li><a href="<?php echo base_url('broker/Equity/import_cash_balance'); ?>"><span>Cash Balance</span></a></li>
                ...
                <li><a href="javascript:;"><i class="fa fa-glass"></i> <span>Assets & Liablities</span> </a>
                    <ul class="acc-menu">
                ...
                <li><a href="<?php echo base_url('broker/Commodities'); ?>"><i class="fa fa-bank"></i> <span>Commodities</span> </a></li>
                <li><a href="<?php echo base_url('broker/Equity'); ?>"><i class="fa fa-bar-chart-o"></i> <span>Equity</span> </a></li>
                <li><a href="<?php echo base_url('broker/Fixed_deposits'); ?>"><i class="fa fa-money"></i> <span>Fixed Deposit</span> </a></li>
                <li><a href="<?php echo base_url('broker/Insurances'); ?>"><i class="fa fa-umbrella"></i> <span>Insurance</span> </a></li>
                <li><a href="<?php echo base_url('broker/Mutual_funds'); ?>"><i class="fa fa-puzzle-piece"></i> <span>Mutual Funds</span> </a></li>
				<li><a href="<?php echo base_url('broker/Real_estate'); ?>"><i class="fa fa-building"></i> <span>Real Estate</span> </a></li>
				<li><a href="javascript:;"><i class="fa fa-inr"></i> <span>Finance/Funds</span></a>
                    <ul class="acc-menu">
                ...
                <li><a href="javascript:;"><i class="fa fa-file-text"></i> <span>Reports</span></a>
                    <ul class="acc-menu">
                        <li><a href="javascript:;"><span>Fixed Deposit</span></a>
                            <ul class="acc-menu">
                        ...
                        <li><a href="<?php echo base_url('broker/Mutual_funds/mf_report');?>"><span>Mutual Fund Details</span></a></li>
