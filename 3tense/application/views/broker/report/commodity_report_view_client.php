...
if(empty($commodity_rep_data)) {
    ...
    $adjCounter = 0;
    if(!empty($commodity_rep_data)) {
        $clientID = $commodity_rep_data[0]->client_id;
        $clientName = $commodity_rep_data[0]->client_name;
    } else {
        $clientID = "";
        $clientName = "";
    }
    ...
    $title = '<div class="title row">Commodity Portfolio of '.$clientName.'</div>
                    <br/>';
    if($commodity_rep_data)
    {
        ...
        {
            if($header) {
                $htmlVal .= '<tr nobr="true" class="head-row">
            ...
            if($content) {
                ...
                $htmlVal .= '<tr nobr="true">
                        ...
                        <td class="border normal">'.round($row->quantity, 3).' '.$row->unit_name.'</td>';
            ...
            <form action="#" id="report_form" method="post" class="form-horizontal row-border">
                <div class="panel panel-midnightblue">
                    <div class="panel-gray panel-body collapse in panel-noborder" >
                        ...
                        <input type="hidden" name="report_name" id="reportName" value="<?php echo $clientName;?> Commodity Portfolio" />
                    </div>
                </div>
            </form>
        </div>
