...
if(empty($asset_rep_data) && empty($liability_rep_data)) {
    ...
    if($asset_rep_data)
    {
        ...
        foreach($asset_rep_data as $row)
        {
            ...
            $mat = ($row->type_name == "SIP")?0:$row->expected_mat_value;
            $totalExpMat = round($totalExpMat + $mat);
            ...
            $html .= '<tr>
                ...
                if($row->type_name == "SIP") { 
                    $html .= '<td class="border normal">Mutual Fund</td>
                            <td class="border normal">'.$row->scheme_name.'</td>
                            <td class="border normal">'.$row->folio_no.'</td>';  
                } else { 
                    $html .= '<td class="border normal">'.$row->company_name.'</td>
                            <td class="border normal">'.$row->scheme_name.'</td>
                            <td class="border normal">'.$row->ref_number.'</td>';
                }
            $html .= '<td class="border normal">'.$row->type_name.'</td>
