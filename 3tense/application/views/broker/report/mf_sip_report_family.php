...
else
{
    ...
    $familyName=$sip_data['0']->family_name;
    $title = '<div class="title row">Family Wise SIP Report of '.$sip_data['0']->family_name.' Family</div><br/>';
    if($sip_data)
    {
            ...
            <form action="#" id="report_form" method="post" class="form-horizontal row-border">
                <div class="panel panel-midnightblue">
                    <div class="panel-gray panel-body collapse in panel-noborder">
                        ...
                        <input type="hidden" name="report_name" id="reportName" value="<?php echo $familyName;?> SIP Report" />
                    </div>
                </div>
            </form>
        </div>
