...
if(empty($eq_rep_data) && empty($eq_values_data)) {
    ...
    if($eq_values_data)
    {
        ...
        foreach($eq_values_data as $row)
        {
            ...
            if($content) {
                ...
                $htmlEqVal .= '<tr nobr="true">
                        ...
                        <td class="border normal amount">'.$this->common_lib->moneyFormatIndia(round($row->apc)).'</td>
                        <td class="border normal amount">'.$this->common_lib->moneyFormatIndia(round($row->purchase_value)).'</td>';
        ...
        $total_value_ind=0;  
        foreach($eq_values_industry_data as $row){ 
                ...
                <div class="panel panel-midnightblue" >
                    <div class="panel-gray panel-body collapse in panel-noborder">
                        ...
                        <div class="row" id="report_data"  style="overflow-x: auto;">
                            ...
                            <?php echo $htmlEqVal; ?></div>
                        <br>
                        <?php  if($broker_id=='0004' || $broker_id=='0009' || $broker_id=='0174' ||  $broker_id=='0196'){
