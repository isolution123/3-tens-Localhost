...
if(!empty($report_info['id']) && !empty($report_info['name'])) {
    $familyID = $report_info['id'];
    $familyName = $report_info['name'];
} else {
    $familyID = "";
    $familyName = "";
}
...
$title = '<div class="title row">Ledger Report of '.$familyName.'</div>
                    <br/>';
...
if($ledger_rep_inflow_data)
{
    ...
    foreach($ledger_rep_inflow_data as $row)
    {
        ...
        $htmlVal .= '<td class="border normal">'.$row->ClientName.'</td>';
                    $htmlVal .= '<td class="border normal">'.$row->ProductName.'</td>';
            ...
            <form action="#" id="report_form" method="post" class="form-horizontal row-border">
                <div class="panel panel-midnightblue">
                    <div class="panel-gray panel-body collapse in panel-noborder">
                        ...
                        <input type="hidden" name="report_name" id="reportName" value="<?php echo $familyName;?> Ledger Report" />
                    </div>
                </div>
            </form>
        </div>
