...
if(empty($mf_rep_data)) {
    ...
    $title = '<div class="title row">Mutual Fund Portfolio of '.$familyName.' Family</div><br/>';
    if($mf_rep_data)
    {
        ...
        for($i = 0; $i < $mfCount; $i++)
        {
            ...
            if($familyFoot)
            {
                ...
                $html .= '<tr>
                        <td colspan="17" class="no-border info">
                            Weighted Avg. CAGR: '.$gTotalCagr.' | Weighted Avg. Abs Return: '.$gTotal_abs.' | Notional (Gain/Loss) Rs.'.($gTotal - $gTotalPurAmt).'.
                        </td>
                    </tr>
            ...
            $html .= '<tr nobr="true">
                ...
                if(!empty($divAmt))
                    ...
                    $html .= '<td class="border normal"></td>';
            $html .= '<td class="border normal">'.$mf_rep_data[$i]->p_nav.'</td>
                <td class="border normal">'.$mf_rep_data[$i]->live_unit.'</td>
                <td class="border normal">'.$mf_rep_data[$i]->transaction_day.'</td>
                <td class="border normal">'.$mf_rep_data[$i]->c_nav.'</td>
                ...
                <td class="border normal">'.$mf_rep_data[$i]->cagr.'</td>
                <td class="border normal">'.$mf_rep_data[$i]->mf_abs.'</td>
                </tr>';
        ...
        $html .= '<tr nobr="true" border="0"><td colspan="3" border="0" class="default no-border"><br/></td></tr>
            <tr nobr="true">
                    ...
                    <td class="dataTotal border">'.$fTotalLiveUnit.'</td>
                    <td class="border normal" colspan="3"></td>';
        ...
        $html .= '<td class="dataTotal border amount">'.$this->common_lib->moneyFormatIndia($fTotal).'</td>
                    <td class="dataTotal border">'.$fTotalCagr.'</td>
                    <td class="dataTotal border">'.$fTotal_abs.'</td>
                </tr>
                <tr>
        ...
        $html .= '</tr>
                ...
                /*<tr nobr="true">
                 ...
                 <tr nobr="true">
                    <td colspan="17" class="no-border amount">
                        <p class="client-name">Current Value of Total Investment is: '.$this->common_lib->moneyFormatIndia(round($fTotalCurValue)).'</p>
                    </td>
                </tr>*/
        $html .= '<tr nobr="true" border="0"><td colspan="3" border="0" class="default no-border"><br/></td></tr>
                <tr nobr="true" border="0"><td colspan="3" border="0" class="default no-border"><br/></td></tr>
