...
if($eq_values_data)
{
    ...
    foreach($eq_values_data as $row)
    {
        ...
        if($header) {
            ...
            $htmlEqVal .= '<tr nobr="true">
                        ...
                        if($broker_id=='0004' || $broker_id=='0009' || $broker_id=='0174')
                            {
                         $htmlEqVal .='<th width="170">Scrip Name</th>
                                <th width="130">Quantity</th>
                                <th width="130">Market Price</th>
                         ...
                         $htmlEqVal.='<th width="150">Industry</th>
                            ...
                            {
                            $htmlEqVal .='<th width="250">Scrip Name</th>
                                <th width="150">Quantity</th>
                                <th width="170">Market Price</th>
                                <th width="170">Market Value</th>
                                <th width="170">% to Portfolio</th>';
                            }
                        $htmlEqVal .='</tr>
                    </tbody>
                    <tbody>';
    ...
    $htmlEqVal .= '<tr nobr="true">
                    ...
                    if(!empty($totalSum)) {
                     ...
                     if($broker_id=='0004' || $broker_id=='0009' || $broker_id=='0174')
                            {
                    $htmlEqVal .= '<td class="dataTotal amount noWrap border"></td><td class="dataTotal amount noWrap border"></td><td class="dataTotal amount noWrap border"></td>
                    </tr>
                    <tr nobr="true" border="0"><td colspan="7" border="0" class="default no-border"><br/></td></tr>
                    <tr nobr="true" border="0"><td colspan="7" border="0" class="default no-border"><br/></td></tr>
                    <tr nobr="true" border="0"><td colspan="7" border="0" class="default no-border"><br/></td></tr>
