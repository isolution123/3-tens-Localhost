...
if(empty($eq_rep_data) && empty($eq_values_data)) {
    ...
    if($eq_values_data)
    {
        ...
        foreach($eq_values_data as $row)
        {
            ...
            if($footer) {
                $htmlEqVal .= '<tr nobr="true">
                        ...
                        if($broker_id=='0004' || $broker_id=='0009' || $broker_id=='0174')
                        {
                ...
                $htmlEqVal .= '<tr nobr="true">
                          ...
                          if($broker_id=='0004' || $broker_id=='0009' || $broker_id=='0174')
                        {
                         $htmlEqVal .= '<tr nobr="true" class="head-row">
                            <th width="170">Scrip Name</th>
                            <th width=130">Quantity</th>
                            <th width="150">Market Price</th>
                            <th width="130">Market Value</th>
                            <th width="130">% to Portfolio</th>';
                        ...
                        {
                            $htmlEqVal .= '<tr nobr="true" class="head-row">
                            <th width="250">Scrip Name</th>
                            <th width="140">Quantity</th>
                            <th width="160">Market Price</th>
                            <th width="160">Market Value</th>
                            <th width="160">% to Portfolio</th>';
                        }
        ...
        $htmlEqVal .= '<tr nobr="true">
                        ...
                        {
                        $htmlEqVal .= '<td class="dataTotal amount noWrap border"></td>
                        <td class="dataTotal amount noWrap border"></td>
                        <td class="dataTotal amount noWrap border"></td>
                    </tr>
                    <tr nobr="true" border="0"><td colspan="7" border="0" class="default no-border"><br/></td></tr>
                    <tr nobr="true" border="0"><td colspan="7" border="0" class="default no-border"><br/></td></tr>
