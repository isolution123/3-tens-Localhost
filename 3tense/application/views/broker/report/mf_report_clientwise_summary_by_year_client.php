...
else
{
  ...
  $title = '<div class="title row">Client Wise Summary Mutual Fund Portfolio of '.$clientName.' By Year</div><br/>';
  ...
  foreach($mf_rep_data as $row)
  {
      ...
      {
        $html .= '<tr nobr="true">
                    <td class="border" colspan="17" align="left"><h4>'.$rowYear.'</h4></td>
                </tr>';
        $newClient = false;
        $newYear=false;
        }
