    ...
    <div id='wrap'>
        <div id="page-heading">
            <ol class="breadcrumb">
                ...
                <li>Imports</li>
                <li class="active">Import BSE Scheme</li>
            </ol>
            <h1>Import BSE Scheme</h1>
        </div>
    </div>
    <div class="container">
        <form action="<?php echo base_url('broker/Mutual_fund_schemes/BSCScheme_import') ?>" id="import_form" method="post" class="form-horizontal row-border" enctype="multipart/form-data">
            <div class="panel panel-midnightblue">
                <div class="panel-heading">
                    <h4>Import BSE Scheme</h4>
                </div>
                <div class="panel-body collapse in">
                    <div class="alert alert-info">
                        <button type="button" class="close" data-dismiss="alert">&times;</button>
                        Import Details for BSE Scheme.<br/>
                        <!-- <a href="javascript:void(0)" id="importHelp" class="alert-link"><i class="fa fa-lightbulb-o"></i> Need Help in upload of excel?</a> --><br/>
                        <a href="<?=base_url('uploads/imports/BSE Scheme Master Format.xlsx?v=2');?>" id="demoFile" class="alert-link"><i class="fa fa-file-excel-o"></i> Download our Demo Import File</a><br/>
