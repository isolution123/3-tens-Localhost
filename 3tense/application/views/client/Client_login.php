 ...
 <div class="verticalcenter" style="top: 35%;" align="center">
   ...
   <div class="panel panel-primary">
     <div class="panel-body">
      ...
      #echo form_open('client/Clients_users/login', $attributes); ?>
 <form method="post" action="<?php echo base_url().'broker/users/login'; ?>" name="form1" class="form login" style="margin-bottom: 0px !important;" >

       <div class="form__field">
         <label class="label" for="login__username"><svg class="icon"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#user"></use></svg><span class="hidden">Username</span></label>
         <input id="login__username" type="text" name="username" class="form__input" placeholder="Username" required autofocus="off">
       </div>

       <div class="form__field">
         <label class="label" for="login__password"><svg class="icon"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#lock"></use></svg><span class="hidden">Password</span></label>
         <input id="login__password" type="password" name="password" class="form__input" placeholder="Password" required>
       </div>

       <center style="padding-top:20px; background-color: rgba(43, 84, 164, 0) !important;">
          ...
          <label style="background-color: rgba(43, 84, 164, 0) !important;"><input type="radio" name="collection" value="yes" >  Client</label>
             ...
             <?php #echo $this->session->flashdata('msg'); ?>
                 <div class="panel-footer">
                     ...
                     <br>
 <a href="<?php echo base_url('client/Clients_forget');?>" class="pull-left btn btn-link " style="padding-left:0">Forgot password?</a>
                 </div>
             <?php
           #  echo form_close();
             ?>
           ...
           $(document).ready(function($) {
               ...
               radio.change(function(e) {
                   ...
                   if (choice === 'yes') {
                       form.attr('action', '<?php echo base_url().'client/Clients_users/login';?>');
                   } else {
                       form.attr('action', '<?php echo base_url().'broker/users/login';?>');
                   }
               });
           });
           </script>
