<div id="page-content" xmlns="http://www.w3.org/1999/html" xmlns="http://www.w3.org/1999/html">
    <div id='wrap'>
        <div id="page-heading">
            <h1>Commodity Report</h1>
        </div>
        <div class="container">
            <form action="#" id="commodity_report_form" method="post" class="form-horizontal row-border">
                <div class="panel panel-midnightblue">
                    <div class="panel-heading">
                        <h4>Commodity Report Info</h4>
                    </div>
                    <div class="panel-body collapse in">
                        <div class="row">
                            ...
                            <div class="form-group" style="text-align: center">
                                <button type="button" class="btn btn-success ladda-button" tabindex="3" id="commodity_submit" data-style="expand-right"><i class="fa fa-file-text-o"></i> <span class="ladda-label">Generate Report</span></button>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    $(function() {
        ...
        $("#commodity_submit").click(function(){
            ...
            if ((famName != null && famName.length != 0) || (client_id != null && client_id.length != 0)) {
                $.ajax({
                    url: "<?php echo site_url('broker/Commodities/get_commodity_report');?>",
                    type: 'post',
                    ...
                    success: function(data)
                    {
                        if(data['Status'])
                        {
                            window.open("<?php echo site_url('broker/Reports/get_commodity_report');?>", '_blank')
                        }
                        else
                        {
