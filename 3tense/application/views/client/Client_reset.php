...
<div class="verticalcenter" style="top: 35%;">
    <a href="<?php echo base_url('client/Clients_users'); ?>"><img src="<?php echo base_url(); ?>assets/users/img/logo-big.png" alt="Logo" class="brand" /></a>
    <div class="panel panel-primary">
        <div class="panel-body">
          ...
          //  echo form_open('client/Clients_forget/set', $attributes); ?>
          <form method="post" action="<?php echo base_url().'broker/forget/set'; ?>" name="form1" class="form login" style="margin-bottom: 0px !important;" >
            ...
            <div class="form__field">
              ...
              <input type="password" name="password" id="password" required placeholder="Password" value="<?php echo set_value('password');?>">
            </div>
            ...
            <div class="form__field">
              <label for="Confirm Password"><svg class="icon"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#lock"></use></svg><span class="hidden">Confirm Password</span></label>
              <input type="password" name="confirm" id="confirm" required placeholder="Confirm Password">
            </div>

            <center><div>
            <input type="radio" name="collection" value="no" checked>Advisor
              <input type="radio" name="collection" value="yes" >Client
          ...
          $(document).ready(function($) {
              ...
              radio.change(function(e) {
                  ...
                  if (choice === 'yes') {
                      form.attr('action', '<?php echo base_url().'client/Clients_forget/set';?>');
                  } else {
                      form.attr('action', '<?php echo base_url().'broker/forget/set';?>');
                  }
              });
          });
          </script>
